...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ManagedServiceAccountProjected) DeepCopyInto(out *ManagedServiceAccountProjected) {
	*out = *in
	if in.Secret != nil {
		in, out := &in.Secret, &out.Secret
		*out = new(ProjectedSecret)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ManagedServiceAccountProjected.
func (in *ManagedServiceAccountProjected) DeepCopy() *ManagedServiceAccountProjected {
	if in == nil {
		return nil
	}
	out := new(ManagedServiceAccountProjected)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ManagedServiceAccountSpec) DeepCopyInto(out *ManagedServiceAccountSpec) {
	*out = *in
	in.Projected.DeepCopyInto(&out.Projected)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProjectedSecret) DeepCopyInto(out *ProjectedSecret) {
	*out = *in
	if in.Labels != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProjectedSecret.
func (in *ProjectedSecret) DeepCopy() *ProjectedSecret {
	if in == nil {
		return nil
	}
	out := new(ProjectedSecret)
