...
import (
	...
	apisauthenticationv1beta1 "open-cluster-management.io/managed-serviceaccount/apis/authentication/v1beta1"
	...
	authenticationv1beta1 "open-cluster-management.io/managed-serviceaccount/pkg/generated/listers/authentication/v1beta1"
)
...
type ManagedServiceAccountInformer interface {
	...
	Lister() authenticationv1beta1.ManagedServiceAccountLister
}
...
func NewFilteredManagedServiceAccountInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&apisauthenticationv1beta1.ManagedServiceAccount{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *managedServiceAccountInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisauthenticationv1beta1.ManagedServiceAccount{}, f.defaultInformer)
}

func (f *managedServiceAccountInformer) Lister() authenticationv1beta1.ManagedServiceAccountLister {
	return authenticationv1beta1.NewManagedServiceAccountLister(f.Informer().GetIndexer())
}
