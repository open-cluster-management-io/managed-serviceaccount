...
type FakeManagedServiceAccounts struct {
	Fake *FakeManagedserviceaccountV1alpha1
	ns   string
}

var managedserviceaccountsResource = schema.GroupVersionResource{Group: "managedserviceaccount", Version: "v1alpha1", Resource: "managedserviceaccounts"}

var managedserviceaccountsKind = schema.GroupVersionKind{Group: "managedserviceaccount", Version: "v1alpha1", Kind: "ManagedServiceAccount"}
...
func (c *FakeManagedServiceAccounts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(managedserviceaccountsResource, c.ns, name), &v1alpha1.ManagedServiceAccount{})
