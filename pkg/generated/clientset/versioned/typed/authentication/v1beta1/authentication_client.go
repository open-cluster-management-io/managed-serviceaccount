...
// AuthenticationV1beta1Client is used to interact with features provided by the authentication.open-cluster-management.io group.
type AuthenticationV1beta1Client struct {
	restClient rest.Interface
}

func (c *AuthenticationV1beta1Client) ManagedServiceAccounts(namespace string) ManagedServiceAccountInterface {
