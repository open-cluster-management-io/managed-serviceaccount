module open-cluster-management.io/managed-serviceaccount/hack/tools

go 1.26.0

require open-cluster-management.io/clusteradm v1.3.1
...
require (
	...
	sigs.k8s.io/apiserver-network-proxy v0.29.0 // indirect
